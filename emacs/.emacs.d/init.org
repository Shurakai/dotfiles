...
Also check the documentation on http://doc.norang.ca/org-mode.html (also attached to my personal journal, 2023-07-05).
...
(setq org-cycle-separator-lines t) ;; hides empty lines between headlines when looking at an outline
...
#+begin_src emacs-lisp
 (setq org-agenda-files
   (quote
    ("~/Documents/Notizen/privat.org" "~/org/journal_privat.org" )))
#+end_src
...
(setq org-agenda-custom-commands
      '(("a" "Agenda and Home-related tasks"
         (
          ...
          (tags-todo "-KOCHREZEPT-BUCH/!TODO|STARTED|WAITING")
          ; (tags "garden")
          (agenda "")
       ))
       ("r" "Kochrezepte die noch nie gekocht wurden"
         (
...
(custom-set-variables
 ...
 '(package-selected-packages
   (quote
    (org-noter-pdftools use-package org-roam org-cliplink
    org-pdftools org-noter evil org-evil org-ref persist
    org-table-sticky-header org-super-agenda org-chef org-bullets
    magit helm dash-functional typopunct ob-lua lua-mode evil-org
    evil-easymotion ess epresent color-theme-sanityinc-tomorrow
    color-theme)))
