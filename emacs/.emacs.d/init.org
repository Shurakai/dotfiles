...
#+begin_src emacs-lisp
(setq org-stuck-projects '("+LEVEL=3/-DONE-CANCELLED-DEFERRED" ("*") nil ""))
...
#+RESULTS:
| a | Agenda and Home-related tasks   | ((stuck  ((org-agenda-overriding-header Bescheuerte Projekte))) (tags-todo STEUERN) (tags garden) (agenda )) |
