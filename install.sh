...
filenames=("cgvg/cgvgrc" .cgvgrc "gpg/gpg.conf" ".gnupg/gpg.conf" "pentadactyl/pentadactylrc" .pentadactylrc "screen/screenrc" .screenrc "git/gitconfig" .gitconfig "most/.mostrc" ".mostrc" "X11/Xresources" .Xresources "X11/Xmodmap" .Xmodmap "xmonad/xsession" ".xsession" "xmonad/" ".xmonad" "xmonad/xmobarrc" ".xmobarrc" "zsh/zshrc" .zshrc "zsh/zshenv" .zshenv)
