...
filenames=(.cgvgrc .cgvgrc gpg.conf ../.gnupg/gpg.conf .screenrc .screenrc .gitconfig .gitconfig "most/.mostrc" ".mostrc" .Xresources .Xresources .Xmodmap .Xmodmap "xmonad/xsession" ".xsession" "xmonad/" ".xmonad" "xmonad/xmobarrc" ".xmobarrc" "zsh/zshrc" .zshrc "zsh/zshenv" .zshenv)
