...
filenames=(.screenrc .screenrc .gitconfig .gitconfig .Xdefaults .Xdefaults .Xmodmap .Xmodmap "xmonad/xsession" ".xsession" "xmonad/" ".xmonad" "xmonad/xmobarrc" ".xmobarrc" "zsh/zshrc" .zshrc)
