...
filenames=(.cgvgrc .cgvgrc .screenrc .screenrc .gitconfig .gitconfig .Xresources .Xresources .Xmodmap .Xmodmap "xmonad/xsession" ".xsession" "xmonad/" ".xmonad" "xmonad/xmobarrc" ".xmobarrc" "zsh/zshrc" .zshrc "zsh/zshenv" .zshenv)
